 ...
 * @param value
 * @returns {boolean} true if the value is truthy, false if the value is falsy
 */
function isTruthyOrFalsy(value) {
	// Use a ternary operator to return true if the value is truthy, otherwise return false
